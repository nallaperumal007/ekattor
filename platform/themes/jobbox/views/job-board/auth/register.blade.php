                ...
                {!!
                    $form
                        ...
                        ->when(setting('job_board_enabled_register_as_employer', 1), function ($form) {
                            return $form
                                ->modify('is_employer', 'html', ['html' => sprintf('<div class="col-6"><label class="cb-container">
                                    <input type="checkbox" name="is_employer" value="1">
                                    <span class="text-small">%s</span>
                                    <span class="checkmark"></span>
                                </label></div>', __('Is Employer?'))], true);
                        })
                         ->modify('agree_terms_and_policy', 'html', ['html' => sprintf('<div class="col-6"><label class="cb-container">
